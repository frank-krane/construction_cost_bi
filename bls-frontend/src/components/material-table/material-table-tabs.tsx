...
export default function MaterialTableTabs() {
    return (
        <Tabs selectedKey={useGroupByStore((state: GroupByState)=> state.groupBy)} fullWidth onSelectionChange={(key) => useGroupByStore.setState({ groupBy: key as MaterialTableGroupBy })}>
