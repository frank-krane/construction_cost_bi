...
import { DurationState, useDurationStore } from "@/store/material-duration-tab-store";
import { Tab, Tabs } from "@nextui-org/tabs";

export default function MaterialChartTabs() {
    return (
        <Tabs selectedKey={useDurationStore((state: DurationState)=> state.duration)} fullWidth onSelectionChange={(key) => useDurationStore.setState({ duration: key as MaterialChartPeriod })}>
